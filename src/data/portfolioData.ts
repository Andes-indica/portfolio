...
export const portfolioData: PortfolioData = {
  personal: {
    ...
    bioParagraphs: [
      ...
      "I'm a third-year Computer Science student with a Cybersecurity minor at IIIT Dharwad. I enjoy building reliable full-stack, systems, and DevOps projects while understanding the real-world problems and business value behind them.",

      "My interest in technology and financial markets inspired projects such as a multi-client Portfolio & Order Management System and an Indian market risk engine. I also contribute to open-source projects, working on CI/CD automation, testing, documentation, and production-focused engineering."
    ],
